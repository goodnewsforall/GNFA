  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: FutureBuilder<List<GnfaLiveDetailsRecord>>(
          ...
          builder: (context, snapshot) {
            ...
            List<GnfaLiveDetailsRecord> columnGnfaLiveDetailsRecordList =
                snapshot.data!;
            // Return an empty Container when the item does not exist.
            if (snapshot.data!.isEmpty) {
              return Container();
            }
            final columnGnfaLiveDetailsRecord =
                columnGnfaLiveDetailsRecordList.isNotEmpty
                    ? columnGnfaLiveDetailsRecordList.first
                    : null;
                  ...
                  child: Align(
                    ...
                    child: Padding(
                      ...
                      child: FlutterFlowAudioPlayer(
                        audio: Audio.network(
                          columnGnfaLiveDetailsRecord!.liveUrl,
                          metas: Metas(
